...
import about_us_banner_img from '@/public/Photos/about_us_banner.jpg';
import { FaArrowRightLong } from "react-icons/fa6";


export const metadata = {
  title: "Optimizing Businesses with Smart IT & Geospatial Technologies",
            ...
            <div className="w-full max-w-[1600px] mx-auto grid grid-cols-2 gap-[5rem] max-sm:grid-cols-1 max-sm:gap-8 items-stretch relative min-h-[600px]">
              <div className="flex flex-col justify-between space-y-6 transform hover:scale-[1.02] transition-all duration-500 backdrop-blur-sm bg-black/20 p-8 rounded-2xl h-full">
                <div className="space-y-6">
                  {[
                    "Techmapperz is in the run of becoming one of the leading IT & GIS company in India. Our company provides solutions combining GIS mapping with drone services and software development as well as Web and Mobile Application Development and IT consultancy to serve industries such as urban planning alongside agriculture, real estate, logistics, environmental management and infrastructure development.",
                    "Our company employs GIS experts together with IT professionals and developers to create personalized solutions which boost decisions and streamline operations and promote business expansion. Techmapperz applies cutting-edge technology through superior mapping solutions and drone surveying systems and custom enterprise platforms and Customer Relationship Management (CRM) systems to support digital success for businesses.",
                    "Techmapperz leads the future evolution of geospatial intelligence and IT services through its dedication to excellence and client success together with continuous innovation."
                  ].map((text, index) => (
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-6 mt-8">
                    ...
                    <div className="relative group">
                      <div className="absolute -left-4 top-0 w-2 h-full bg-gradient-to-b from-[#00B0FE] to-transparent rounded-full group-hover:h-[120%] transition-all duration-300"></div>
                      <p className="text-lg max-sm:text-base leading-relaxed text-gray-300 text-justify pl-4 group-hover:text-white transition-colors duration-300">
                        Our approach centers on client success and innovation through precise integration of ArcGIS, QGIS, Agisoft, AutoCAD, etc. platforms together with drone-based LiDAR, Image processing, etc. for GIS Solutions and JavaScript, React, Next.js, Node.js, Tailwind CSS, PHP, MySQL, etc. for IT Solutions.
                      </p>
                    </div>
                  </div>
                </div>
