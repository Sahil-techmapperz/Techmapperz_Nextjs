...
const WebsiteBanner = ({ title, subtitle, description, buttonText, imageSrc, imageAlt }) => {
	return (
		<section className=" min-h-[80vh] mt-10 banner w-full flex items-center relative bg-gradient-to-r from-[#376bab] from-40% to-[#d2292b]" >
			<div className="absolute inset-y-0 left-0 w-[45%] bg-gradient-to-r from-black to-transparent"></div>
