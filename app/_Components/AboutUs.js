    ...
    >
      ...
      <div className="z-[2]  flex flex-col max-sm:gap-2 gap-[6rem] md:flex-row justify-between items-center  w-full max-w-7xl mx-auto">
        <div className="w-full md:w-1/2 flex flex-col items-center relative">
          <Image src={home_about_us_banner} alt="Home About Us Banner" className="mb-8 " />
        </div>
        <div className="w-full md:w-1/2 text-center md:text-left  z-[2]">
          ...
          <h1 className="text-white text-3xl max-sm:text-[20px] font-semibold mb-6">Why Choose Techmapperz?</h1>
          <p className="text-gray-300 text-lg max-sm:text-[16px] mb-4">
            The smaller things make a big difference in everything that we do. At Techmapperz, we believe in the attention-to-detail methodology, and our eye for detail in every project is what makes us stand out from the rest. We follow a four-step process to execute each project plan.
          </p>
          <p className="text-gray-300 text-lg max-sm:text-[16px] mb-4">
