...
const Resources = ({ sections, title, subtitle, link = "#" }) => {
  ...
  return (
    ...
    >
      <Link
        href={link}
        className={`text-lg text-white transition-transform duration-300 hover:scale-105 relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[4px] after:bg-red-500 after:transition-all after:duration-300 hover:after:w-full`}
      >
        {title}
      </Link>
