...
const designElements = [
    {
        id: 1,
        primaryImage: '/Photos/Combind1.png',
        title: 'Graphics',
        description:
    ...
    {
        id: 2,
        primaryImage: '/Photos/Combind5.png',
        title: 'Navigation',
        description:
    ...
    {
        id: 3,
        primaryImage: '/Photos/Combind3.png',
        title: 'Colour',
        description:
    ...
    {
        id: 4,
        primaryImage: '/Photos/Combind4.png',
        title: 'Speed',
        description:
        ...
        <>
            ...
            <div
                ...
                style={{
                    ...
                    backgroundSize: 'cover',  // Ensures the image covers the area without zooming
