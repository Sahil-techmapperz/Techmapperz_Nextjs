"use client"
import Career4 from '@/public/Photos/our_mision_img.png'
import Career5 from '@/public/Photos/our_vsion_img.png'
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto grid grid-cols-2 gap-[5rem] max-sm:gap-2 max-sm:grid-cols-1 justify-center items-center overflow-x-hidden">
      <div className="flex flex-col">
        <Image src={Career4} alt="" className=" w-[70%] mx-auto" />
      ...
      <div className="flex flex-col" >
        <Image src={Career5} alt="" className="w-[70%]  mx-auto" />
