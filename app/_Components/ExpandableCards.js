	...
	const cards = [
		{
			...
			bgImage: '/Roadmap/Discovery_Workshop.jpg'
		},
		{
			id: '02',
			...
			bgImage: '/Roadmap/Planning&Documentation.jpg'
		},
		{
			id: '03',
			title: 'UX/UI Design',
			...
			bgImage: '/Roadmap/UXUI_Design.jpg'
		},
		{
			id: '04',
			title: 'Development',
			...
			bgImage: '/Roadmap/Development.jpg'
		},
		{
			id: '05',
		...
		},
		{
			...
			bgImage: '/Roadmap/Support&Maintenance.jpg'
		}
	]
				...
				{cards.map((card, index) => (
					<motion.div
						...
						className={`relative bg-[#0A1229]/60 backdrop-blur-sm p-4 md:p-6 cursor-pointer group overflow-hidden ${
							index !== cards.length - 1 ? 'border-b-2 md:border-b-0 md:border-r-[1px] border-white' : ''
