                    ...
                    <div className='text-white flex flex-col gap-4 justify-center max-sm:items-center max-sm:gap-0'>
                        <p className='text-4xl max-sm:text-center max-sm:text-[14px] font-bold'> Empowering Your Business with Innovation
                            <TypeAnimation
                                ...
                                speed={50}
                                repeat={Infinity}
                                className='text-[#00B0FE] text-4xl max-sm:text-[14px] font-bold ml-2 max-sm:block max-sm:ml-0'
                            />
                        ...
                        <Link
                            href="/contact"
                            className="relative  mt-5 ml-5 max-sm:ml-0 inline-flex items-center gap-2 uppercase w-fit font-semibold text-[22px] text-[#00B0FE] py-2 px-4 bg-white rounded-lg overflow-hidden group"
                        >
