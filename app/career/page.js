...
export const metadata = {
  title: "Pursuing a Future Where Technology Simplifies Complexity",
    ...
    <div className="bg-black text-white">
      ...
      <div className="bg-[#ECF1FD] w-full flex max-sm:flex-col-reverse justify-between text-black py-[20px] px-[50px] max-sm:px-[10px] max-sm:justify-center">
        <div className="flex flex-col justify-center gap-4">
          ...
          <p className="font-[600] max-sm:text-[14px]">For Job Inquiry : - <span className="text-[#E81515]"> info@techmapperz.com </span></p>
