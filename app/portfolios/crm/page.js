...
import crm_banner from "@/public/Photos/crm_banner.webp";
import crm_logo from "@/public/Photos/crm_logo.webp";
import crm_Challenges from "@/public/Photos/crm_Challenges.webp";
import crm_Solutions from "@/public/Photos/crm_Solutions.webp";
import crm_Results from "@/public/Photos/crm_Results.webp";
import crm_Inconclusion from "@/public/Photos/crm_Inconclusion.webp";
...
export const metadata = {
  title: "All In one CRM | Techmapperz CRM | Customize Data | Techmapperz | India",
  description: "Techmapperz CRM serves as an adaptable solution for optimal business operations that provides smooth data handling alongside automation and client relationship management functions.",
  alternates: {
    ...
    <div id='CaseStudiesITServices' className='bg-gray-900'>
      ...
      <div className='w-full m-auto bg-gray-900'>
        ...
        <div className='w-full max-w-[1600px] mx-auto text-white flex justify-center flex-col  relative'>
          ...
          <Image src={crm_logo} className='m-auto py-4' alt={crm_logo} />
          ...
          <Image src={crm_banner} className='m-auto' alt={crm_banner} />
