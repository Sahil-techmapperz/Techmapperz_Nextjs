...
import whitespreadfoods_banner from "@/public/Photos/whitespreadfoods_banner.webp";
import whitespreadfoods_logo from "@/public/Photos/whitespreadfoods_logo.webp";
import whitespreadfoods_Challenges from "@/public/Photos/whitespreadfoods_Challenges.webp";
import whitespreadfoods_Solutions from "@/public/Photos/whitespreadfoods_Solutions.webp";
import whitespreadfoods_Results from "@/public/Photos/whitespreadfoods_Results.webp";
import whitespreadfoods_Inconclusion from "@/public/Photos/whitespreadfoods_Inconclusion.webp";
...
export const metadata = {
  title: "Store Dashboard | Real-Time Insights for Business Efficiency | Techmapperz | India",
  description: "Techmapperz builds Store dashboards which allow executives to monitor KPIs and supply chain along with quality indicators and trends to enhance decision efficiency.",
  alternates: {
  ...
  return (
    <div id='CaseStudiesITServices' className='bg-gray-900'>
      ...
      <div className='flex flex-col h-[350px] text-center items-center justify-center bg-cover bg-center' style={{ backgroundImage: 'url("/Photos/Rectangle41.webp")' }}>
        <p class="text-white mt-[66px] mb-[30px] text-[66px] max-sm:text-[50px] font-bold sm:text-[50px]">IT Portfolio</p>        {/* <p className='text-white'>IT Portfolio</p> */}
        {/* <Link
          href="/contact"
      ...
      <div className='w-full m-auto bg-gray-900'>
        ...
        <div className='w-full max-w-[1600px] mx-auto text-white flex justify-center flex-col  relative'>
          ...
          <Image src={whitespreadfoods_logo} className='m-auto py-4 w-[350px]' alt='Co-Createall2' />
          <p className='m-auto text-[20px] font-[600]'>White Spread Foods </p>
          <p className='w-[65%] max-sm:w-full m-auto text-center'>
            The White Spread Foods Dashboard can be described as an all-encompassing solution intended to give information on
          ...
          <Image src={whitespreadfoods_banner} className='m-auto' alt='Co-Createall2' />
        ...
        <div className="w-full flex flex-col justify-center text-white items-center">
          ...
          <p className='w-[40%] max-sm:w-full text-center'>
