...
import shrc_banner from "@/public/Photos/shrc_banner.webp";
import Shrc_logo from "@/public/Photos/Shrc_logo.webp";
import shrc_Challenges from "@/public/Photos/shrc_Challenges.webp";
import shrc_Solutions from "@/public/Photos/shrc_Solutions.webp";
import shrc_Results from "@/public/Photos/shrc_Results.webp";
import shrc_Inconclusion from "@/public/Photos/shrc_Inconclusion.webp";
    ...
    <div id='CaseStudiesITServices' className='bg-gray-900'>
      ...
      <div className='w-full m-auto bg-gray-900'>
        ...
        <div className='w-full max-w-[1600px] mx-auto text-white flex justify-center flex-col  relative'>
          ...
          <Image src={Shrc_logo} className='w-[50px] m-auto py-4' alt='Welho_logo' />
          ...
          <Image src={shrc_banner} className='mx-auto' alt='Welho_banner' />
