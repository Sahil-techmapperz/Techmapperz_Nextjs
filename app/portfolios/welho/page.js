...
import Welho_banner from "@/public/Photos/Welho_banner.webp";
import Welho_logo from "@/public/Photos/welho_logo.webp";
import welho_Challenges from "@/public/Photos/welho_Challenges.webp";
import welho_Solutions from "@/public/Photos/welho_Solutions.webp";
import welho_Results from "@/public/Photos/welho_Results.webp";
import welho_Inconclusion from "@/public/Photos/welho_Inconclusion.webp";
...
export const metadata = {
  title: "Custom Website Growth | fitness Website | Techmapperz | India",
  description: "Get high-performance websites tailored to your industry. From fitness platforms to e-commerce, we build scalable, engaging and conversion-driven sites.",
  alternates: {
    ...
    <div id='CaseStudiesITServices' className='bg-gray-900'>
      ...
      <div className='w-full m-auto bg-gray-900'>
        ...
        <div className='w-full max-w-[1600px] mx-auto text-white flex justify-center flex-col  relative'>
          ...
          <Image src={Welho_logo} className='m-auto py-4' alt='Welho_logo' />
          ...
          <Image src={Welho_banner} className='w-full' alt='Welho_banner' />
