...
import premierautosource_banner from "@/public/Photos/premierautosource_banner.webp";
import premierautosource_logo from "@/public/Photos/premierautosource_logo.webp";
import premierautosource_Challenges from "@/public/Photos/premierautosource_Challenges.webp";
import premierautosource_Solutions from "@/public/Photos/premierautosource_Solutions.webp";
import premierautosource_Results from "@/public/Photos/premierautosource_Results.webp";
import premierautosource_Inconclusion from "@/public/Photos/premierautosource_Inconclusion.webp";
...
export const metadata = {
  title: "Secure WebSite| Web development Security Feature | Techmapperz",
  description: "Customers can secure their website through Techmapperz's cutting-edge security features. Our security measures include firewalls with SSL encryption in combination with threat investigation services which safeguard your business from Internet attacks.",
  alternates: {
    ...
    <div id='CaseStudiesITServices' className='bg-gray-900'>
      ...
      <div className='w-full m-auto bg-gray-900'>
        ...
        <div className='w-full max-w-[1600px] mx-auto text-white flex justify-center flex-col  relative'>
          ...
          <Image src={premierautosource_logo} className='m-auto py-4' alt='Welho_logo' />
          ...
          <Image src={premierautosource_banner} className='mt-[20px] w-full' alt='Welho_banner' />
