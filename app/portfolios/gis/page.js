	...
	return (
		<div className="min-h-screen bg-gray-900">
			...
			<div className="relative w-full">
				<Image src={Portfolio_banner} className="w-full h-[400px] object-cover" alt="GIS Portfolio Banner" />
				<div className="absolute inset-0 w-full h-full bg-black bg-opacity-60 flex flex-col justify-center items-center">
					<h1 className="text-center text-5xl text-white font-bold">GIS Solutions Portfolio</h1>
					<p className="text-center text-xl text-gray-200 mt-4 px-4 md:px-8 md:w-[60%]">
						Advanced Geographic Information Systems solutions for spatial analysis and mapping
					</p>
