...
import fabcon_banner from "@/public/Photos/fabcon_banner.webp";
import fabcon_Challenges from "@/public/Photos/fabcon_Challenges.webp";
import fabcon_Solutions from "@/public/Photos/fabcon_Solutions.webp";
import fabcon_Results from "@/public/Photos/fabcon_Results.webp";
import fabcon_Inconclusion from "@/public/Photos/fabcon_Inconclusion.webp";
...
import Homecontact from '@/app/_Components/Homecontact';
    ...
    <div id='CaseStudiesITServices' className='bg-gray-900'>
      ...
      <div className='w-full m-auto bg-gray-900'>
        ...
        <div className='w-full max-w-[1600px] mx-auto text-white flex justify-center flex-col  relative'>
          ...
          <Image src={Fabcon_Logo} className='m-auto py-4 w-[20%]' alt='Fabcon Logo' />
          ...
          <Image src={fabcon_banner} className='m-auto' alt='Co-Createall2' />

        </div>

        <div className=" max-sm:bg-gray-900 text-white py-5 px-5 mt-[100px]" style={{ background: "linear-gradient(90deg, #393939 44.98%, #010101 86.2%)" }}>
