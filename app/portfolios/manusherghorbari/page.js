...
import manusherghorbari_banner from "@/public/Photos/manusherghorbari_banner.webp";
import manusherghorbari_logo from "@/public/Photos/manusherghorbari_logo.webp";
import manusherghorbari_Challenges from "@/public/Photos/manusherghorbari_Challenges.webp";
import manusherghorbari_Solutions from "@/public/Photos/welho_Results.webp";
import manusherghorbari_Results from "@/public/Photos/manusherghorbari_Results.webp";
import manusherghorbari_Inconclusion from "@/public/Photos/manusherghorbari_Inconclusion.webp";
...
export const metadata = {
  title: "Manusher Ghorbari Hotel Booking Website | Case Study | Techmapperz",
  description: "Explore how Techmapperz built a user-friendly booking site for Manusher Ghorbari, offering real-time availability, secure payments, and a seamless travel experience.",
  alternates: {
    ...
    <div id='CaseStudiesITServices' className='bg-gray-900'>
      ...
      <div className='w-full m-auto bg-gray-900'>
        ...
        <div className='w-full max-w-[1600px] mx-auto text-white flex justify-center flex-col  relative'>
          ...
          <Image src={manusherghorbari_logo} className='m-auto py-4' alt='Welho_logo' />
          ...
          <Image src={manusherghorbari_banner} className='mx-auto' alt='Welho_banner' />
