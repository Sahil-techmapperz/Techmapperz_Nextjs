...
export const metadata = {
    title: 'Elevate Your Business with Custom Web Development',
...
const WebDevelopment = () => {
    ...
    const imageSrc = "/Photos/webdevelopment_introduction.png";
    ...
    const bannerData = {
        ...
        imageSrc: "/Photos/Webdevelopment_Mockup_banner.png",
        ...
        <div className="bg-black text-white relative">
            ...
            <section className="w-full overflow-hidden">
                ...
                <OurServices
                    ...
                    imageSrc="/Photos/webdevelopment_service_we_offers.png"
                    imageAlt="Web Development Services"
                    services={ourServicesData}
                />

                <div className=" relative  bg-cover bg-center " style={{ backgroundImage: "url('/Photos/banner_3.jpg')" }}>
                    <div className="px-20 py-10 flex max-sm:flex-col-reverse max-sm:gap-2 max-sm:px-2 max-sm:items-center justify-center gap-10 items-center w-full max-w-[1600px] m-auto">
                        ...
                        <Image src="/Photos/Why_web Design_Important.png" unoptimized="true" alt="" className='w-[30%] rounded-md max-sm:w-[90vw]' width={100} height={100} />
                    </div>
                </div>
