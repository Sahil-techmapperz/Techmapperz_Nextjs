...
const Mobile_development = () => {
    ...
    const bannerData = {
        ...
        imageSrc: "/Photos/mobile_development_Mockup_banner.png",
        ...
        <div className="bg-black text-white">
            ...
            <section className="w-full bg-black p-10 max-sm:px-4">
                ...
                <OurServices
                    ...
                    imageSrc="/Photos/mobiledevelopment_service_we_offers.png"
