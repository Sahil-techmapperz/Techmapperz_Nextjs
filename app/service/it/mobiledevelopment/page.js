            ...
            <section className="w-full bg-black p-10 max-sm:px-4">
                ...
                <div className="w-full py-10">
                    <div className="flex flex-col md:flex-row gap-10 bg-black">
                        <div className="w-full md:w-1/2 flex flex-col gap-5">
                            <h1 className="text-4xl max-sm:text-2xl">Our Mobile App Development Services</h1>
                            <p>We provide iOS and Android mobile application development services to leverage mobile technology for your business.</p>
                            <h2 className="text-xl max-sm:text-[18px] font-bold">Android App Development</h2>
                            <ul className="list-disc max-sm:text-[16px] list-inside text-[#396ba9]">
                            ...
                            <p className='text-[18px] max-sm:text-[16px]'>Market Development - Android has more than 80% of the market share in the handheld device market, making it arguably the most popular market.</p>
                            <button
                ...
                <div className="w-full py-10">
                    <div className="flex flex-col md:flex-row gap-10 bg-black">
                        ...
                        <div className="w-full md:w-1/2 flex flex-col gap-5">
                            <h1 className="text-4xl max-sm:text-2xl">iOS App Development</h1>
                            ...
                            <p className='text-[18px] max-sm:text-[18px]'>Source - Apple's stringent data protection standards make sensitive corporate data lodged in iPhone applications very safe and secure.</p>
                            <button
                                    className='py-[10px] px-[15px] w-fit rounded-sm'
                                    style={{
                                        background: "linear-gradient(90deg, #EC212C 0%, #396BA9 100%)",
                ...
                <div className="w-full py-10 flex max-sm:flex-col-reverse sm:flex-row gap-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="flex flex-col items-center text-center p-5 border-r border-b max-sm:border-none">
                        ...
                        <div className="flex flex-col items-center text-center p-5 border-b max-sm:border-none">
                        ...
                        <div className="flex flex-col items-center text-center p-5 border-r max-sm:border-none">
