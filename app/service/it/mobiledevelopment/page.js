...
const Mobile_development = () => {
    ...
    return (
        <div className="bg-black text-white">
            ...
            <section className="h-96 max-sm:px-4 max-sm:text-center max-sm:h-[250px] w-full flex flex-col justify-center items-center bg-cover bg-center" style={{ backgroundImage: "url('/Photos/banner_3.jpg')" }}>
                <h1 className="text-4xl max-sm:text-2xl">Mobile Application Development</h1>
                <p className="text-[18px] max-sm:text-[16px] mt-2"><Link href={"/"}> Home </Link> / <Link href={"/service"}>Service </Link> / Mobile Application Development</p>
            </section>
            ...
            <section className="w-full bg-black p-10 max-sm:px-4">
                ...
                <div className="w-full py-10">
                    <div className="flex flex-col-reverse md:flex-row gap-10 bg-black">
                        <div className="w-full md:w-1/2 flex flex-col gap-5">
                            <h1 className="text-4xl max-sm:text-2xl max-sm:text-center">Our Mobile App Development Services</h1>
                            <p className='max-sm:text-center'>We provide iOS and Android mobile application development services to leverage mobile technology for your business.</p>
                            <h2 className="text-xl max-sm:text-center max-sm:text-[18px] font-bold">Android App Development</h2>
                            <ul className="list-disc max-sm:text-[14px] max-sm:m-auto list-inside text-[#396ba9]">
                            ...
                            <p className='text-[18px] max-sm:text-center max-sm:text-[16px]'>Market Development - Android has more than 80% of the market share in the handheld device market, making it arguably the most popular market.</p>
                            <button
                                className='py-[10px] max-sm:m-auto px-[15px] w-fit rounded-sm'
                                style={{
                ...
                <div className="w-full py-10">
                    <div className="flex flex-col md:flex-row gap-10 bg-black">
                        ...
                        <div className="w-full md:w-1/2 flex flex-col gap-5">
                            <h1 className="text-4xl max-sm:text-center max-sm:text-2xl">iOS App Development</h1>
                            <ul className="list-disc  text-[18px] max-sm:text-[14px] max-sm:m-auto list-inside text-[#396ba9]">
                            ...
                            <p className='text-[18px] max-sm:text-center max-sm:text-[18px]'>Source - Apple's stringent data protection standards make sensitive corporate data lodged in iPhone applications very safe and secure.</p>
                            <button
                                    className='py-[10px] max-sm:m-auto px-[15px] w-fit rounded-sm'
                                    style={{
                                        background: "linear-gradient(90deg, #EC212C 0%, #396BA9 100%)",
                ...
                <div className="w-full py-10" >
                    <h1 className="text-4xl max-sm:text-2xl text-center mb-10">Types of Mobile Application</h1>
                ...
                <div className="w-full py-10 flex max-sm:flex-col sm:flex-row gap-10">
                    <div className='flex flex-col w-full'>
                        <h1 className="text-4xl max-sm:text-2xl text-center mb-10">How Mobile Applications Grow Your Business?</h1>
                        <img className="w-full max-sm:h-[40vh] object-cover" src={"/Photos/MobileDev16.gif"} alt="MobileDev16" />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="flex flex-col items-center text-center max-sm:p-0 p-5 border-r border-b max-sm:border-none">
                            ...
                            <p className="text-justify leading-relaxed text-[18px] max-sm:text-[16px]">We generally conduct market research to determine your exact requirements and what your rivals are doing. We analyze their strengths and shortcomings so that we can avoid making the same mistakes.</p>
                        </div>
                        <div className="flex flex-col items-center text-center max-sm:p-0 p-5 border-b max-sm:border-none">
                            ...
                            <p className="text-justify leading-relaxed text-[18px] max-sm:text-[16px]">We focus on newer avenues in the marketplace for the execution of mobile applications to generate sales at progressive levels within a short span of time.</p>
                        </div>
                        <div className="flex flex-col items-center text-center max-sm:p-0 p-5 border-r border-b max-sm:border-none">
                            ...
                            <p className="text-justify leading-relaxed text-[18px] max-sm:text-[16px]">Our design team conceptualizes the most hassle-free user interface. We take special care to make it user-friendly.</p>
                        </div>
                        <div className="flex flex-col items-center text-center max-sm:p-0 p-5 border-b max-sm:border-none">
                            ...
                            <p className="text-justify leading-relaxed text-[18px] max-sm:text-[16px]">According to your need and market research, we design a framework for your app. We keep in mind all your requirements and what we have learned from the market research.</p>
                        </div>
                        <div className="flex flex-col items-center text-center max-sm:p-0 p-5 border-r max-sm:border-none">
                            ...
                            <p className="text-justify leading-relaxed text-[18px] max-sm:text-[16px]">Mobile apps are a one-stop point for getting all the relevant information related to the brand as well as showcasing the products and services, thus increasing the overall brand value.</p>
                        </div>
                        <div className="flex flex-col items-center text-center max-sm:p-0 p-5">
                            ...
                            <p className="text-justify leading-relaxed text-[18px] max-sm:text-[16px]">We take your suggestions to incorporate in-app advertising, in-app purchases, and paid apps are some of the most common app monetization tactics.</p>
                        </div>
                    </div>
                </div>

                <div className="w-full py-10">
                    <h1 className="text-4xl max-sm:text-2xl text-center mb-10">Why Choose Us</h1>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        <div className="flex flex-col items-center text-center p-5 max-sm:p-0">
