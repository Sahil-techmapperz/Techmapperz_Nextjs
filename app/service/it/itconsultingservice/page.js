            ...
            <section className="w-full bg-black ">
                ...
                <div className="grid grid-cols-3 max-sm:grid-cols-1 max-sm:gap-2 max-sm:px-2 gap-12 px-20 mt-10">
                    ...
                    <div className="border p-8">
                        ...
                        <h3 className="text-2xl max-sm:text-xl font-bold mt-4">Digital Transformations</h3>
                        <p className='text-[18px] max-sm:text-[16px]'>Digital Transformation is the integration of Digital technology into your business. With our team of experts, we'll help you work smarter.</p>
                    </div>
                    ...
                    <div className="border p-8">
                        ...
                        <h3 className="text-2xl max-sm:text-xl font-bold mt-4">Strategy Consulting</h3>
                        <p className='text-[18px] max-sm:text-[16px]'>Strategy consulting is an important aspect of digital transformation. With this package, we offer one-on-ones with our consultants to assess where you are at now.</p>
                    </div>

                    <div className="border p-8">
                        <Image src={Itconsulting1} alt="Implementation" loading="lazy" width={100} height={100} />
                        <h3 className="text-2xl max-sm:text-xl font-bold mt-4">Implementation</h3>
                ...
                <div className="bg-cover bg-center py-10  mt-10 grid grid-cols-2 max-sm:grid-cols-1" style={{ backgroundImage: "url('/Photos/Rectangle 41.png')" }}>
                  <div>
                    ...
                    <div className="grid grid-cols-2 max-sm:grid-cols-1 max-sm:pr-0 pr-20">
                        <div className="border-r border-b p-8">
                            ...
                            <h3 className="text-2xl max-sm:text-xl font-bold mb-2">Reliability</h3>
                            <p className='text-[18px] max-sm:text-[16px]'>With the accumulated experience of more than 20 years, our team is well equipped to help you solve all possible challenges in the customer management field.</p>
                        </div>
                        ...
                        <div className="border-b p-8">
                            ...
                            <h3 className="text-2xl max-sm:text-xl font-bold mb-2">Revenue</h3>
                            <p className='text-[18px] max-sm:text-[16px]'>With global competition and greater customer expectations companies look forward to enhance customer relationship and experience, many business entities.</p>
                        </div>
                        ...
                        <div className="p-8">
                            ...
                            <h3 className="text-2xl max-sm:text-xl font-bold mb-2">Robust</h3>
                            <p className='text-[18px] max-sm:text-[16px]'>At custom CRM consulting we understand your current capabilities, map your organisation's desired future state, and then recommend CRM implementation.</p>
                        </div>
                        ...
                        <div className="border-l p-8">
                            ...
                            <h3 className="text-2xl max-sm:text-xl font-bold mb-2">Skilled Management</h3>
                            <p className='text-[18px] max-sm:text-[16px]'>CRM integration is connecting all the applications you use to run your business to customer information, it's a 360-degree view of customer data that can be seamlessly.</p>
                        </div>
                    </div>
                </div>
            </section>
