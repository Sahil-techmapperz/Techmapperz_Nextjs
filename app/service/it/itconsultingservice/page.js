...
export const metadata = {
    title: "Unlock Business Potential with Expert IT Consulting",
    description: "Techmapperz map your business",
};

const ItConsulting = () => {
    const introData = {
        imageSrc: "/Photos/IT_Consulting_Introduction.png",
    ...
    const bannerData = {
        ...
        imageSrc: "/Photos/it_Consultancy_Mockup_banner.png",
        ...
        <div className="bg-gray-900 text-white relative">
            ...
            <section className="w-full bg-black ">
                ...
                <OurServices
                    ...
                    imageSrc="/Photos/IT_Consulting_service_we_offers.png"
