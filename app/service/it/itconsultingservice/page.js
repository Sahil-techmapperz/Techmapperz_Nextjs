            ...
            <section className="w-full bg-black ">
                ...
                <div className="grid grid-cols-3 max-sm:grid-cols-1 max-sm:gap-2 max-sm:px-2 gap-12 px-20 mt-10">
                    ...
                    <div className="border p-8">
                        ...
                        <p className='text-[18px] max-sm:text-[16px]'>Strategy consulting is an important aspect of digital transformation. With this package, we offer one-on-one with our consultants to assess where you are at now.</p>
                    </div>
