...
import Drone_Service1 from '@/public/Photos/GIS/drone_service_1.avif';
import Drone_Service2 from '@/public/Photos/GIS/drone_service_2.avif';
import Drone_Service3 from '@/public/Photos/GIS/drone_service_3.avif';
                        ...
                        <div className="relative">
                            <div className="flex flex-col gap-4">
                                ...
                                <p className="text-[18px] max-sm:text-[16px] leading-7 text-justify">
                                    ...
                                    er processing workstations and sophisticated post-processing tools and methods 
                                    to process the high-resolution drone dataset. We can deliver Seamless
                        ...
                        <div className="flex flex-col max-sm:flex-col-reverse md:flex-row justify-center items-center gap-20">
                            <div className="relative md:w-1/2">
                                ...
                                <p className="text-[18px] max-sm:text-[16px] leading-7 text-justify mb-4">
                                    ...
                                    assist you in survey and planning. We provide you Site Monitoring with
                                    a comprehensive base map and topography data analysis to manage 
                                    complex issues associated with large infrastructure projects and land 
                                    record management. Our photogrammetry experts can even support 
                                    you in any remote sensing projects or drone data processing.
                                </p>
                                <div className='flex max-sm:flex-col  max-sm:gap-1 gap-8 ml-5'>
                                    <ul className="list-disc font-semibold text-[18px] max-sm:text-[16px]">
