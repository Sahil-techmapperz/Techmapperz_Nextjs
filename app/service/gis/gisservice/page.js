...
import Geospatial_Mapping from '@/public/Photos/GIS/2D3D Image Extraction.avif';
import Geo_health from '@/public/Photos/GIS/gis_service_img_2.avif';
import Geogoverence from '@/public/Photos/GIS/gis_service_img_3.avif';
import GIS_Suvey from '@/public/Photos/GIS/gis_service_img_4.avif';
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-col lg:flex-row-reverse gap-8">
            ...
            <div className="flex flex-col gap-4">
              <p className="text-white text-[18px] max-sm:text-[16px]">
                GIS plays a very vital role in the modern health sector. GIS can play an important role in the surveillance, management and analysis of diseases. Techmapperz's GIS-based Health solution will help you in monitoring and management of both diseases and health programs. We use the latest software and accurate GIS data to improve your strategic planning, research and evaluation, emergency preparedness and both response and location of health care service too.
              </p>
              <button
                className='py-[10px] px-[15px] w-fit rounded-sm'
                style={{
