...
let CaseStudiesData = [
    {
        image: "/Photos/IT_1.png", category: "IT", name: "Fabcon", link: "/portfolios/fabcon", details: [
    ...
    {
        image: "/Photos/Site_Suitability_Analysis.png", category: "GIS", name: "Site Suitability Analysis", link: "/portfolios/site_mapping", details: [
    ...
    {
        image: "/Photos/IT_2.png", category: "IT", name: "Cocreate Lab", link: "/portfolios/cocreatelabs", details: [
    ...
    {
        image: "/Photos/Agricultural_Mapping.png", category: "GIS", name: "Agricultural Mapping", link: "/portfolios/", details: [
    ...
    {
        image: "/Photos/IT_3.png", category: "IT", name: "SHRC", link: "/portfolios/shrc", details: [
    ...
    {
        image: "/Photos/Land_Use_Land_Cover_Mapping.png", category: "GIS", name: "Land-Use  Land -Cover Mapping", link: "/portfolios/landcover_mapping", details: [
    ...
    {
        image: "/Photos/IT_4.png", category: "IT", name: "Premium Auto Services", link: "/portfolios/premierautosource", details: [
    ...
    {
        image: "/Photos/Georeferencing_of_Maps.png", category: "GIS", name: "Georeferencing of Maps", link: "/portfolios/", details: [
    ...
    {
        image: "/Photos/IT_5.png", category: "IT", name: "Welho", link: "/portfolios/welho", details: [
    ...
    {
        image: "/Photos/IT_6.png", category: "IT", name: "Manusher Ghorbari", link: "/portfolios/manusherghorbari", details: [
    ...
    {
        image: "/Photos/Industrial_Planning_and_Mapping.png", category: "GIS", name: "Industrial Planning and Mapping", link: "/portfolios/industrial_mapping", details: [
    ...
    {
        image: "/Photos/City_Mapping.png", category: "GIS", name: "City Mapping", link: "/portfolios/city_mapping", details: [
    ...
    {
        image: "/Photos/IT_7.png", category: "IT", name: "Techmapperz CRM", link: "/portfolios/crm", details: [
